...
.8B4B:
    ...
    lda #$0C : sta $0000,X
    lda #$00 : pha
    lda.w stage_objects+0,Y : sta.w obj.type,X
    pha
    lda.w stage_objects+1,Y
    pha
    and #$1F
    sta $0007,X
    lda.w stage_objects+2,Y : sta.w obj.pos_x+1,X
    lda.w stage_objects+3,Y : sta.w obj.pos_x+2,X
    lda.w stage_objects+4,Y : sta.w obj.pos_y+1,X
    lda.w stage_objects+5,Y : sta.w obj.pos_y+2,X
    ldy $06
...
-:
    ...
    txa : asl : tax
    ldy.w stage_objects,X : sty $3B
    inc $3B
    lda.w stage_objects,Y
    and #$00FF
    beq .8C28
...
.8BF3:
    ...
    lda.w stage_objects+3,Y ;X pos
    bra .8C03

.8C00:
    lda.w stage_objects+5,Y ;Y pos
.8C03:
    lsr #5
    tax
    !A8
...
.F75A: ;stage 3, first tower
    db $01
    dw $01E2 : db $0F
    dw $004E, $00D4, $0158, $01DA, $739C, $4A52, $39CE, $294A, $0000, $0000, $0000, $0000, $0000, $0000, $0421 ;bat palette
