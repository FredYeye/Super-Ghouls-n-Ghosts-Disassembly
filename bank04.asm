...
{ ;A122 -
_04A122: ;graphics related. ppu tilemaps?

    dw .A15A, .A1D9, .A240, .A272, .A322, .A360, .A3C7, .A4A0, .A522, .A5B1, .A635, .A665, .A6A7, .A6B7
    dw .A6C5, .A6D3, .A6DD, .A70F, .A71D, .A733, .A747, .A757, .A779, .A7BA, .A7D8, .A7D9, .A7DA, .A7DB

;-----

.A15A: ;used in stage 1
    db $06 : dw $0084
    dw $2199, $2195, $218A, $21A2, $218E, $219B
    db $07 : dw $00B0
...
elseif !version == 2
    db $00, $00, $00, $00
    incbin "eu_fill_bytes/bank04a.bin" ;almost looks like a table or compressed data in there...
    ;see "lda $04ED00,X : sta $F400,Y ;todo" in bank01
endif
