...
gfx_item_triblade:       incbin "graphics/item_triblade.bin"
gfx_item_bowgun:         incbin "graphics/item_bowgun.bin"
gfx_item_scythe:         incbin "graphics/item_scythe.bin"
gfx_item_torch:          incbin "graphics/item_torch.bin"
gfx_item_axe:            incbin "graphics/item_axe.bin"
gfx_item_knife:          incbin "graphics/item_knife.bin"
gfx_item_shield:         incbin "graphics/item_shield.bin"
gfx_item_bracelet_fairy: incbin "graphics/bracelet_fairy.bin"
gfx_item_bracelet:       incbin "graphics/item_bracelet.bin"
