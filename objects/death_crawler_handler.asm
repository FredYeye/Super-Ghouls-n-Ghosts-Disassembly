...
elseif !version == !EU
    ...
    stz $1546
    stz $1554
    lda #$04 : sta.w ppu_vars.tm : sta.w ppu_vars.ts
...
;----- B24C
    ...
    ldy #$90 : lda.b #task_list_decompress : ldx #$15 : jsl add_task
.B256:
    brk #$00
...
;----- B264
    ...
    ldy #$90 : lda.b #task_list_decompress : ldx #$0E : jsl add_task
.B26E:
    brk #$00
...
;----- B28A
    ...
    lda #$FF : sta $3B
    !A16
    lda #$0080 : sta.w ppu_vars.m7x
    lda #$0280 : sta.w ppu_vars.m7y
    lda #$0060 : sta.w ppu_vars.m7a : sta.w ppu_vars.m7d : sta.w ppu_vars.m7b : sta.w ppu_vars.m7c
    !A8
.B2CD:
...
;----- B2D9
    ...
    lda #$01D0
.B2F2:
    sta.w ppu_vars.m7a : sta.w ppu_vars.m7b : sta.w ppu_vars.m7c : sta.w ppu_vars.m7d
    bcc .B2D7
...
.B4E4:
    ...
    clc : lda.w ppu_vars.m7a : adc #$0004 : sta.w ppu_vars.m7a : sta.w ppu_vars.m7b : sta.w ppu_vars.m7c : sta.w ppu_vars.m7d
    bra .B512

.B4FF:
    sec : lda.w ppu_vars.m7a : sbc #$0004 : sta.w ppu_vars.m7a : sta.w ppu_vars.m7b : sta.w ppu_vars.m7c : sta.w ppu_vars.m7d
.B512:
    !A8
.B514:
    rts
