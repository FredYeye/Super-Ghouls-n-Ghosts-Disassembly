...
_0198A4: ;a- x8
    ;rising wave
    !A8
    ldy.b #task[2].base : lda.b #task_list_34 : jsl add_task
    lda #$11 : sta.w ppu_vars.tm : sta $02D7
    lda #$01 : jsr _019A88
    jsr .9987
    lda #$61 : sta.w ppu_vars.bgmode
    !A16
    lda #$0272 : sta $19DE
    lda #$0272 : sta $19E2
    lda #$0124 : sta $19E0
    ...
    !A8
    jsl _01B90E
    lda #$08 : sta.w ppu_vars.bg2sc
    stz $74
    lda #$0C : sta.w ppu_vars.bg3sc
    lda #$04 : sta $031E
if !version == !EU
...
if !version == !JP || !version == !US
    lda #$17 : sta.w ppu_vars.tm : sta $02D7
endif
